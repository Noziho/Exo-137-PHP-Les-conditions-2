...
if($animal === "Chat" && $couleur === "Blanc" && $vivant === true && $yeux === "Vert") {
    echo "Oui";
}
else {
    echo "Non";
...
if($animal === "Chat" && $vivant === true && $couleur === "Marron" && $yeux === "Vert" || $animal === "Chat" && $vivant === true && $couleur === "Blanc" && $yeux === "Vert") {
    echo 'Oui';
}
else {
    echo 'Non';
...
if($animal === "Chien" && $vivant === false && $yeux === "Bleu" && $couleur === "Noir"
    || $animal === "Chat" && $couleur === "Orange" && $vivant === true && $yeux === "Bleu"
    || $animal === "Chien" && $couleur === "Marron" && $yeux === "Bleu" && $vivant === true) {
    echo 'Oui';
}
else {
    echo 'Non';
